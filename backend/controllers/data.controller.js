...
const getVisualizationData = asyncHandler(async (req, res) => {
    try {
        ...
        throw new ApiError(500, "Failed to fetch visualization data");
    }
});
...
const getSummaryData = asyncHandler(async (req, res) => {
    try {
        ...
        throw new ApiError(500, "Failed to fetch summary data");
    }
});

// get data in json and add to db
//  verify data 
const addWeatherData = asyncHandler(async (req, res) => {
